...
function Projects({ projects }: Props) {
  ...
  return (
    <motion.div
      ...
      className="h-[1000px] md:h-[700px] lg:h-[700px] xl:h-[1000px] 2xl:h-screen relative flex flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0 md:mb-32 md:mt-20 xl:pb-40 lg:mt-48"
    >
      ...
      <div className="flex flex-col mt-48 md:mt-0">
        ...
        <div className="relative flex items-center justify-center lg:hidden md:mt-10 mt-48">
          <div className="absolute flex space-x-20 md:bottom-[-200px] bottom-[200px]">
            <ChevronDoubleLeftIcon
              className="w-24 h-24 md:w-20 md:h-20 lg:w-14 lg:h-14 p-1 cursor-pointer hover:bg-white/10 hover:rounded-full hover:p-0 duration-200 "
              onClick={prevSlide}
            />
            <ChevronDoubleRightIcon
              className="w-24 h-24 md:w-20 md:h-20 lg:w-14 lg:h-14 p-1 cursor-pointer hover:bg-white/10 hover:rounded-full hover:p-0 duration-200 "
